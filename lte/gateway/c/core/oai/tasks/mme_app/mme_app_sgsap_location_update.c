 ...
 **
 ***********************************************************************************/
status_code_e send_itti_sgsap_location_update_req(ue_mm_context_t* ue_context_p) {
  OAILOG_FUNC_IN(LOG_MME_APP);
 ...
 ** **
 ***********************************************************************************/
status_code_e mme_app_handle_ts6_1_timer_expiry(zloop_t* loop, int timer_id, void* args) {
  OAILOG_FUNC_IN(LOG_MME_APP);
